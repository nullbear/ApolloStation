...
/client/proc/cmd_admin_dress(var/mob/living/carbon/human/M in mob_list)
	...
	switch(dresscode)
		...
		if("emergency response team")
			...
			M.equip_to_slot_or_qdel(new /obj/item/clothing/glasses/sunglasses(M), slot_glasses)
			M.equip_to_slot_or_qdel(new /obj/item/storage/backpack/satchel(M), slot_back)
		...
		if("blue wizard")
			...
			M.equip_to_slot_or_qdel(new /obj/item/storage/backpack(M), slot_back)
			M.equip_to_slot_or_qdel(new /obj/item/storage/box(M), slot_in_backpack)
