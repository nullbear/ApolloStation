...
/obj/machinery/vending/cigarette
	...
	vend_delay = 34
	icon_state = "cigs"
	products = list(/obj/item/weapon/storage/fancy/cigarettes = 10,/obj/item/storage/box/matches = 10,/obj/item/weapon/flame/lighter/random = 4)
	contraband = list(/obj/item/weapon/flame/lighter/zippo = 4)
	premium = list(/obj/item/weapon/storage/fancy/cigarettes/cigar = 5)
	prices = list(/obj/item/weapon/storage/fancy/cigarettes = 15,/obj/item/storage/box/matches = 1,/obj/item/weapon/flame/lighter/random = 2)
