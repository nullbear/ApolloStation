...
/datum/game_mode/proc/equip_syndicate(mob/living/carbon/human/synd_mob)
	...
	if(synd_mob.backbag == 2) synd_mob.equip_to_slot_or_qdel(new /obj/item/storage/backpack(synd_mob), slot_back)
	if(synd_mob.backbag == 3) synd_mob.equip_to_slot_or_qdel(new /obj/item/storage/backpack/satchel_norm(synd_mob), slot_back)
	if(synd_mob.backbag == 4) synd_mob.equip_to_slot_or_qdel(new /obj/item/storage/backpack/satchel(synd_mob), slot_back)
	synd_mob.equip_to_slot_or_qdel(new /obj/item/storage/box/engineer(synd_mob.back), slot_in_backpack)
