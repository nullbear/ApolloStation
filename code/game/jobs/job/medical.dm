		...
		if (H.mind.role_alt_title)
			switch(H.mind.role_alt_title)
				...
				if("Virologist")
					...
					switch(H.backbag)
						if(2) H.equip_to_slot_or_qdel(new /obj/item/storage/backpack/virology(H), slot_back)
						if(3) H.equip_to_slot_or_qdel(new /obj/item/storage/backpack/satchel_vir(H), slot_back)
						if(4) H.equip_to_slot_or_qdel(new /obj/item/storage/backpack/satchel(H), slot_back)
				if("Medical Doctor")
					H.equip_to_slot_or_qdel(new /obj/item/clothing/under/rank/medical(H), slot_w_uniform)
					H.equip_to_slot_or_qdel(new /obj/item/clothing/suit/storage/toggle/labcoat(H), slot_wear_suit)
