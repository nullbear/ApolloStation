...
/datum/job/captain
	...
	equip(var/mob/living/carbon/human/H)
		...
		switch(H.backbag)
			if(2) H.equip_to_slot_or_qdel(new /obj/item/storage/backpack/captain(H), slot_back)
			if(3) H.equip_to_slot_or_qdel(new /obj/item/storage/backpack/satchel_cap(H), slot_back)
		...
		if(H.backbag == 1)
			H.equip_to_slot_or_qdel(new /obj/item/storage/box/ids(H), slot_r_hand)
		else
			H.equip_to_slot_or_qdel(new /obj/item/storage/box/ids(H.back), slot_in_backpack)
